class CreateUvlSubscriptions < ActiveRecord::Migration
  def change
    create_table :uvl_subscriptions do |t|
      t.references :uvl_office, index: true, foreign_key: true
      ...
      t.references :practise_typology, index: true, foreign_key: true
